...
#define  output "out"
#define  input  "in"
#define  ain1_in "/sys/module/bone_iio_helper/drivers/platform:bone-iio-helper/helper.11/AIN0"
...
while(1)
  ...
  printf("AINO reading [of 1800]: %f\n", ain0_value); 
  ain0_voltage = ((ain0_value/1800.0) * 1.8);
